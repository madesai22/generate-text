...
sample_1 = get_sample_dict_by_category("Category:Activists")
sample_2 = get_sample_dict_by_category("Category:Chief executives in the technology industry")
sample_3 = get_sample_dict_by_category("Category:Scientists")
